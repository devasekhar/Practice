...
public class SolutionTester {
	...
	public static void init() {
		...
		try {
			 list = parser.parse(str, new StrictDataValidator());
		} catch (Exception e) {
	...
	public void testAverageBuilddurationForEachGeozone() {
		...
		Map<String, Double> map = Aggregator.getAverageOfItemsGroupedByK(list, Data::getGeoZone, Data::getBuildDuration);
		assertTrue(expectedMap.equals(map));
	}
	...
	public void testListOfCustomerIdsForEachGeozone() {
		...
		expectedMap.put("eu_west", new HashSet<String>(){{ add("3244132"); add("3244332"); }});
		expectedMap.put("us_west", new HashSet<String>(){{ add("1233456"); add("1223456"); }});
		expectedMap.put("us_east", new HashSet<String>(){{ add("2343225"); }});
		Map<String, Collection<String>> map = Aggregator.getCollectionOfTgroupedByK(list, Data::getGeoZone,Data::getCustomerId, HashSet::new);
		assertTrue(expectedMap.equals(map));
	}
}
